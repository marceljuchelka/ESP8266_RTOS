...
const 	PROGMEM ULP_VAR_STRUCT _ulp_flash_hodnoty = {M_span_def,Sens_code_def,PPM_minim};
		EEMEM	ULP_VAR_STRUCT _ulp_eeprom_hodnoty = {M_span_def,Sens_code_def,PPM_minim};

ULP_pins_U ULP_pins_U_global;
ULP_VAR_STRUCT ULP_promenne_global;
